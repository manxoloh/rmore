                                            ...
                                            <div class="product-full-image main-slider image-popup">
                                                ...
                                                <div class="swiper-wrapper">
                                                    <figure class="swiper-slide">
                                                        <a href="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-1.jpg" data-size="600x600">
                                                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-1.jpg" alt="Product Image">
                                                    ...
                                                    <figure class="swiper-slide">
                                                        <a href="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-2.jpg" data-size="600x600">
                                                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-2.jpg" alt="Product Image">
                                                            <div class="image-overlay"><i class="fa fa-search-plus"></i></div>
                                                        </a>
                                                        <figcaption class="visually-hidden">
                                                            <span>Product Image</span>
                                                    ...
                                                    <figure class="swiper-slide">
                                                        <a href="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-3.jpg" data-size="600x600">
                                                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-3.jpg" alt="Product Image">
                                                            <div class="image-overlay"><i class="fa fa-search-plus"></i></div>
                                                        </a>
                                                        <figcaption class="visually-hidden">
                                                            <span>Product Image</span>
                                                    ...
                                                    <figure class="swiper-slide">
                                                        <a href="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-4.jpg" data-size="600x600">
                                                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-4.jpg" alt="Product Image">
                                                            <div class="image-overlay"><i class="fa fa-search-plus"></i></div>
                                                        </a>
                                                        <figcaption class="visually-hidden">
                                                            <span>Product Image</span>
                                                    ...
                                                    <figure class="swiper-slide">
                                                        <a href="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-5.jpg" data-size="600x600">
                                                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-5.jpg" alt="Product Image">
                                                            <div class="image-overlay"><i class="fa fa-search-plus"></i></div>
                                                        </a>
                                                        <figcaption class="visually-hidden">
                                                            <span>Product Image</span>
                                                    ...
                                                    <figure class="swiper-slide">
                                                        <a href="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-6.jpg" data-size="600x600">
                                                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-6.jpg" alt="Product Image">
                                                            <div class="image-overlay"><i class="fa fa-search-plus"></i></div>
                                                        </a>
                                                        <figcaption class="visually-hidden">
                                                            <span>Product Image</span>
                                                ...
                                                <div class="nav-slider">
                                                    ...
                                                    <div class="swiper-wrapper">
                                                        <div class="swiper-slide">
                                                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-thumb-1.jpg" alt="Product Thumbnail Image">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-thumb-2.jpg" alt="Product Thumbnail Image">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-thumb-3.jpg" alt="Product Thumbnail Image">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-thumb-4.jpg" alt="Product Thumbnail Image">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-thumb-5.jpg" alt="Product Thumbnail Image">
                                                        </div>
                                                        <div class="swiper-slide">
                                                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/single/product-thumb-6.jpg" alt="Product Thumbnail Image">
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="tab-pane fade" id="tab_product_details" role="tabpanel" aria-labelledby="nav_product_details">
                                        	<div class="product-tab-details d-flex justify-content-center align-content-center">
                                        		<div class="product-brand align-self-center mr-md-5">
                                        			<img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/product-brand.png" alt="Brand Icon">
                                        		</div>
                                ...
                                <div class="product-thumb">
                                    <div class="product-inner">
                                        <div class="product-image">
                                            ...
                                            <a href="<?= Url::to(['/site/product-details']) ?>">
                                        ...
                                        <div class="product-caption">
                                            ...
                                            <h4 class="product-name"><a href="<?= Url::to(['/site/product-details']) ?>">Fusion Backpack</a></h4>
                                ...
                                <div class="product-thumb">
                                    <div class="product-inner">
                                        ...
                                        <div class="product-caption">
                                            ...
                                            <h4 class="product-name"><a href="<?= Url::to(['/site/product-details']) ?>">Rival Field Messenger 6</a></h4>
                                            <p class="product-price">
                                ...
                                <div class="product-thumb">
                                    <div class="product-inner">
                                        ...
                                        <div class="product-caption">
                                            ...
                                            <h4 class="product-name"><a href="<?= Url::to(['/site/product-details']) ?>">Strive Shoulder Pack</a></h4>
                                            <p class="product-price">
                                ...
                                <div class="product-thumb">
                                    <div class="product-inner">
                                        ...
                                        <div class="product-caption">
                                            ...
                                            <h4 class="product-name"><a href="<?= Url::to(['/site/product-details']) ?>">Wayfarer Messenger Bag</a></h4>
                                            <p class="product-price">
                                ...
                                <div class="product-thumb">
                                    <div class="product-inner">
                                        ...
                                        <div class="product-caption">
                                            ...
                                            <h4 class="product-name"><a href="<?= Url::to(['/site/product-details']) ?>">Rival Field Messenger</a></h4>
                                            <p class="product-price">
                                ...
                                <div class="product-thumb">
                                    <div class="product-inner">
                                        ...
                                        <div class="product-caption">
                                            ...
                                            <h4 class="product-name"><a href="<?= Url::to(['/site/product-details']) ?>">Crown Summit Backpack</a></h4>
                                            <p class="product-price">
