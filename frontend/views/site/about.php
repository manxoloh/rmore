        ...
        <div class="row align-items-center">
            ...
            <div class="col-12 col-sm-12 col-md-5 col-lg-6">
                <div class="overview-img text-center">
                    <a href="#">
                        <img src="<?= Yii::$app->request->baseUrl?>/theme/images/about/about.jpg" alt="About Us">
                    </a>
                </div>
            </div>
        </div> <!-- end of row -->
        ...
        <div class="row">
            <div class="col-6 col-sm-6 col-md-6 col-lg-3">
                <div class="team-wrapper">
                    <div class="team-media">
                        <a href="#">
                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/about/team-1.jpg" alt="Team Image">
                        </a>
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-3">
                <div class="team-wrapper">
                    <div class="team-media">
                        <a href="#">
                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/about/team-4.jpg" alt="Team Image">
                        </a>
                        <div class="team-socials">
                            <div class="chain-animation">
                                <a class="bg-facebook" href="#">
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-3">
                <div class="team-wrapper">
                    <div class="team-media">
                        <a href="#">
                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/about/team-2.jpg" alt="Team Image">
                        </a>
                        <div class="team-socials">
                            <div class="chain-animation">
                                <a class="bg-facebook" href="#">
            ...
            <div class="col-6 col-sm-6 col-md-6 col-lg-3">
                <div class="team-wrapper">
                    <div class="team-media">
                        <a href="#">
                            <img src="<?= Yii::$app->request->baseUrl?>/theme/images/about/team-3.jpg" alt="Team Image">
                        </a>
                        <div class="team-socials">
                            <div class="chain-animation">
                                <a class="bg-facebook" href="#">
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="testimonial-media" data-swiper-parallax="-100">
                                <img src="<?= Yii::$app->request->baseUrl?>/theme/images/testimonial/testimonial-1.jpg" alt="Alva Ono">
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-media" data-swiper-parallax="-100">
                                <img src="<?= Yii::$app->request->baseUrl?>/theme/images/testimonial/testimonial-2.jpg" alt="Dewey Tetzlaff">
                            </div>
                            <div class="testimonial-content" data-swiper-parallax="-500">
                                <p>All Perfect !! I have three sites with magento , this theme is the best !! Excellent support , advice theme installation package , sorry for English, are Italian but I had no problem !! Thank you!</p>
                                <div class="client-meta" data-swiper-parallax="-300">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-media" data-swiper-parallax="-100">
                                <img src="<?= Yii::$app->request->baseUrl?>/theme/images/testimonial/testimonial-3.jpg" alt="Amber Laha">
                            </div>
                            <div class="testimonial-content" data-swiper-parallax="-500">
                                <p>All Perfect !! I have three sites with magento , this theme is the best !! Excellent support , advice theme installation package , sorry for English, are Italian but I had no problem !! Thank you!</p>
                                <div class="client-meta" data-swiper-parallax="-300">
        ...
        <div class="row">
            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                <div class="promo-banner hover-effect-1">
                    <a href="#">
                        <img src="<?= Yii::$app->request->baseUrl?>/theme/images/banners/banner-9.jpg" alt="Promo Banner">
                    </a>
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                <div class="promo-banner hover-effect-1">
                    <a href="#">
                        <img src="<?= Yii::$app->request->baseUrl?>/theme/images/banners/banner-10.jpg" alt="Promo Banner">
                    </a>
                </div> <!-- end of promo-banner -->
            </div>
        </div> <!-- end of row -->
