                                                        ...
                                                        <div class="product-inner">
                                                            <div class="product-image">
                                                                ...
                                                                <a href="<?= Url::to(['/site/product-details']) ?>">
                                                                    <img src="<?= Yii::$app->request->baseUrl."admin/uploads/".$product['featured_image'] ?>" alt="<?= $product['product_name'] ?>" title="<?= $product['product_name'] ?>">
                                                                </a>
                                                            ...
                                                            <div class="product-caption">
                                                                ...
                                                                <h4 class="product-name"><a href="<?= Url::to(['/site/product-details']) ?>"><?= $product['description'] ?></a></h4>
                                                                <p class="product-price">
                                                                    <span class="price-old">KES <?= $product['price'] + 500 ?></span>
                                                                    <span class="price-new">KES <?= $product['price'] ?></span>
                                                                </p>
                                                        ...
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mb-4 mb-md-0 mr-md-4 mr-xl-5">
                                                                    ...
                                                                    <div class="label-product label-new">New</div>
                                                                    <a href="<?= Url::to(['/site/product-details']) ?>">
                                                                        <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/new/product-1.jpg" title="Compete Track Tote" alt="Compete Track Tote">
                                                                    </a>
                                                                    <div class="action-links">
                                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                ...
                                                                <div class="product-caption media-body">
                                                                    ...
                                                                    <h4 class="product-name">
                                                                        <a href="<?= Url::to(['/site/product-details']) ?>">Compete Track Tote</a>
                                                                    </h4>
                                                                    <div class="product-ratings">
                                                                        <div class="rating-box">
                                                                            <ul class="rating d-flex">
                                                        ...
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mb-4 mb-md-0 mr-md-4 mr-xl-5">
                                                                    <div class="label-product label-new">New</div>
                                                                    <a href="<?= Url::to(['/site/product-details']) ?>">
                                                                        <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/new/product-9.jpg" title="Wayfarer Messenger Bag" alt="Wayfarer Messenger Bag">
                                                                    </a>
                                                                    <div class="action-links">
                                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                ...
                                                                <div class="product-caption media-body">
                                                                    ...
                                                                    <h4 class="product-name">
                                                                        <a href="<?= Url::to(['/site/product-details']) ?>">Wayfarer Messenger Bag</a>
                                                                    </h4>
                                                                    <div class="product-ratings">
                                                                        <div class="rating-box">
                                                                            <ul class="rating d-flex">
                                                        ...
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mb-4 mb-md-0 mr-md-4 mr-xl-5">
                                                                    <div class="label-product label-new">New</div>
                                                                    <a href="<?= Url::to(['/site/product-details']) ?>">
                                                                        <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/new/product-2.jpg" title="Fusion Backpack" alt="Fusion Backpack">
                                                                    </a>
                                                                    <div class="action-links">
                                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                ...
                                                                <div class="product-caption media-body">
                                                                    ...
                                                                    <h4 class="product-name">
                                                                        <a href="<?= Url::to(['/site/product-details']) ?>">Fusion Backpack</a>
                                                                    </h4>
                                                                    <div class="product-ratings">
                                                                        <div class="rating-box">
                                                                            <ul class="rating d-flex">
                                                        ...
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mb-4 mb-md-0 mr-md-4 mr-xl-5">
                                                                    ...
                                                                    <div class="label-product label-new">New</div>
                                                                    <a href="<?= Url::to(['/site/product-details']) ?>">
                                                                        <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/new/product-10.jpg" title="Strive Shoulder Pack" alt="Strive Shoulder Pack">
                                                                    </a>
                                                                    <div class="action-links">
                                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                ...
                                                                <div class="product-caption media-body">
                                                                    ...
                                                                    <h4 class="product-name">
                                                                        <a href="<?= Url::to(['/site/product-details']) ?>">Strive Shoulder Pack</a>
                                                                    </h4>
                                                                    <div class="product-ratings">
                                                                        <div class="rating-box">
                                                                            <ul class="rating d-flex">
                                                        ...
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mb-4 mb-md-0 mr-md-4 mr-xl-5">
                                                                    <div class="label-product label-new">New</div>
                                                                    <a href="<?= Url::to(['/site/product-details']) ?>">
                                                                        <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/new/product-3.jpg" title="Rival Field Messenger 6" alt="Rival Field Messenger 6">
                                                                    </a>
                                                                    <div class="action-links">
                                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                ...
                                                                <div class="product-caption media-body">
                                                                    ...
                                                                    <h4 class="product-name">
                                                                        <a href="<?= Url::to(['/site/product-details']) ?>">Rival Field Messenger 6</a>
                                                                    </h4>
                                                                    <div class="product-ratings">
                                                                        <div class="rating-box">
                                                                            <ul class="rating d-flex">
                                                        ...
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mb-4 mb-md-0 mr-md-4 mr-xl-5">
                                                                    <div class="label-product label-new">New</div>
                                                                    <a href="<?= Url::to(['/site/product-details']) ?>">
                                                                        <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/new/product-11.jpg" title="Rival Field Messenger" alt="Rival Field Messenger">
                                                                    </a>
                                                                    <div class="action-links">
                                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                ...
                                                                <div class="product-caption media-body">
                                                                    ...
                                                                    <h4 class="product-name">
                                                                        <a href="<?= Url::to(['/site/product-details']) ?>">Rival Field Messenger</a>
                                                                    </h4>
                                                                    <div class="product-ratings">
                                                                        <div class="rating-box">
                                                                            <ul class="rating d-flex">
                                                        ...
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mb-4 mb-md-0 mr-md-4 mr-xl-5">
                                                                    <div class="label-product label-new">New</div>
                                                                    <a href="<?= Url::to(['/site/product-details']) ?>">
                                                                        <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/new/product-4.jpg" title="Rival Field Messenger" alt="Rival Field Messenger">
                                                                    </a>
                                                                    <div class="action-links">
                                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                        ...
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mb-4 mb-md-0 mr-md-4 mr-xl-5">
                                                                    <div class="label-product label-new">New</div>
                                                                    <a href="<?= Url::to(['/site/product-details']) ?>">
                                                                        <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/new/product-12.jpg" title="Crown Summit Backpack" alt="Crown Summit Backpack">
                                                                    </a>
                                                                    <div class="action-links">
                                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
                                                                ...
                                                                <div class="product-caption media-body">
                                                                    ...
                                                                    <h4 class="product-name">
                                                                        <a href="<?= Url::to(['/site/product-details']) ?>">Crown Summit Backpack</a>
                                                                    </h4>
                                                                    <div class="product-ratings">
                                                                        <div class="rating-box">
                                                                            <ul class="rating d-flex">
                                                        ...
                                                        <div class="product-thumb">
                                                            <div class="product-inner media align-items-center">
                                                                <div class="product-image mb-4 mb-md-0 mr-md-4 mr-xl-5">
                                                                    <div class="label-product label-new">New</div>
                                                                    <a href="<?= Url::to(['/site/product-details']) ?>">
                                                                        <img src="<?= Yii::$app->request->baseUrl?>/theme/images/products/new/product-5.jpg" title="Crown Summit Backpack" alt="Crown Summit Backpack">
                                                                    </a>
                                                                    <div class="action-links">
                                                                        <a class="action-btn btn-cart" href="#" title="Add to Cart"><i class="pe-7s-shopbag"></i></a>
                                                                        <a class="action-btn btn-wishlist" href="#" title="Add to Wishlist"><i class="pe-7s-like"></i></a>
